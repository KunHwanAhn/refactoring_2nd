...
- 정보가 사요오디는 곳마다 같은 도출 로직이 반복되면, 이런 작업들을 한데로 모아두면, 검색과 갱신을 일관된 장소에서 처리할 수 있고 로직 중복도 막을 수 있다.
...
### 예시1
 - [ex01.js](./10-combineFunctionsIntoTransform/ex01.js)

## 6-11 단계 쪼개기
- 서로 다른 두 새상을 한꺼번에 다루는 코드를 발견하면 각각을 별개 모듈로 나누는 방법을 모색한다.
...
### 예시1
 - [ex01.js](./11-splitPhase/ex01.js)

### 예시2
 - [ex02.js](./11-splitPhase/ex02.js)
